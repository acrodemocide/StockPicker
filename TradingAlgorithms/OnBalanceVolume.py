...
def obv(stock):
    ...
    while currentIndex < numberOfDays:
        ...
        accumulatedOBV = accumulatedOBV + obvCalculation(previousDayClose, currentDayClose, currentDayVolume)
        currentIndex = currentIndex + 1
    return accumulatedOBV


def obvCalculation(previousDayClose, currentDayClose, currentDayVolume):
